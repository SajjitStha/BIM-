...
file_path = r'Lab_2_Data.csv'  # Updated file path
...
if last_two_rows['Transactions'].isna().any():
    ...
    data.loc[data.tail(2).index, 'Transactions'] = last_two_rows['Predicted_Transactions']
...
# Retrain the models on the entire dataset
X = data[['Sales']].values
